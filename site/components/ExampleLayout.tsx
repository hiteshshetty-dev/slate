...
const TabList = ({
  ...
  <div
    ...
    {...props}
    className={`slate-tab-list ${isVisible ? 'visible' : 'hidden'}`}
  />
)
...
const TabListUnderlay = ({
  ...
  <div
    {...props}
    className={`slate-tab-list-underlay ${isVisible ? 'visible' : 'hidden'}`}
  />
)
